...
![EngramGithub](https://s3.engramnet.io/engram-github.png)
...
`deposit-cli` is a tool for creating [EIP-2335 format](https://eips.ethereum.org/EIPS/eip-2335) BLS12-381 keystores and a corresponding `deposit_data*.json` file for [Engram Staking Launchpad](https://github.com/ethereum/staking-launchpad).
...
See [releases page](https://github.com/Engramnet/staking-deposit-cli/releases) to download and decompress the corresponding binary files.
...
See [releases page](https://github.com/Engramnet/engram-deposit-cli/releases) to download and decompress the corresponding binary files.
