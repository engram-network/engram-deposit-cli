...
EngramSetting = BaseChainSetting(
    NETWORK_NAME=ENGRAM, GENESIS_FORK_VERSION=bytes.fromhex('1000129b'),
    GENESIS_VALIDATORS_ROOT=bytes.fromhex('836b504791e28e4749a5cd409e0022b0d953207bea33d30991c31a4ed5be38ad')
)
